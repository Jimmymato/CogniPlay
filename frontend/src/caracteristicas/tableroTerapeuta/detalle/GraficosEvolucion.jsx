...
export default function GraficosEvolucion({ intentos }) {
  const datos = [...intentos]
    ...
    .map((i) => ({
      fecha: new Date(i.creadoEn).toLocaleDateString('es-PE', {
        day: '2-digit',
        month: 'short',
      }),
    ...
    <section style={tarjeta} aria-label="Evolución en el tiempo">
      ...
      {datos.length < 2 ? (
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 18 }}>
          <div>
            <h3 style={estiloSubtitulo}>Precisión (%)</h3>
            <ResponsiveContainer width="100%" height={200}>
              <AreaChart data={datos} margin={{ top: 6, right: 8, left: -18, bottom: 0 }}>
                ...
                <XAxis dataKey="fecha" tick={ESTILO_TICK} tickLine={false} />
          ...
          <div>
            <h3 style={estiloSubtitulo}>Puntaje</h3>
