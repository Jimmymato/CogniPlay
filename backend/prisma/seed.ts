...
const FUNCIONES: DefFuncion[] = [
  ...
  },
  {
    ...
    color: '#EF4444',
    orden: 3,
    actividad: { nombre: 'Espera la Señal', descripcion: 'Responde solo cuando corresponde.', icono: 'hand' },
  },
  {
    ...
    color: '#F59E0B',
    orden: 4,
    actividad: { nombre: 'Mejor Camino', descripcion: 'Elige la opción más conveniente.', icono: 'route' },
  },
  {
  ...
  },
  {
    ...
    color: '#A855F7',
    orden: 6,
    actividad: { nombre: 'Dos a la Vez', descripcion: 'Realiza dos tareas simultáneas.', icono: 'layers' },
  },
  {
    nombre: 'BRANCHING',
    etiqueta: 'Multitarea',
